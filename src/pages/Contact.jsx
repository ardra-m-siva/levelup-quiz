            ...
            <div className='container'>
                <div className='my-5'>
                    <div className="row gap-3">
                        <div className="col-8 d-flex shadow p-5 align-items-center justify-content-center gap-1" >
                            <div>
                                <h2 className='fw-bold'>Learn anywhere, <br />anytime</h2>
                                <p>On the web or on the go, Sololearn is always ready for you and you'll never lose your place.</p>
                                <div>
                                    <h5 className='my-3'>Get The App Now</h5>
                                    <div className='d-flex'>
                                        <img width={'150px'} className='img-fluid' src="https://www.drupal.org/files/styles/grid-3-2x/public/project-images/googleQRcodes.png?itok=cVevzFXs" alt="" />
                                        <div className='d-flex flex-column justify-content-center ms-5' >
                                            <img className='img-fluid w-75' src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/Download_on_the_App_Store_RGB_blk.svg/2560px-Download_on_the_App_Store_RGB_blk.svg.png" alt="" />
                                            <img className='img-fluid mt-2 w-75' src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/78/Google_Play_Store_badge_EN.svg/2560px-Google_Play_Store_badge_EN.svg.png" alt="" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <img className='img-fluid w-50' src="https://i.pinimg.com/originals/03/c0/38/03c038d16263b1edbd846b4d2cc4ed28.gif" alt="" />
                        </div>
