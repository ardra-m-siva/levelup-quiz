...
const Contact = () => {
    ...
    const handleTestimonialForm = async (e) => {
        e.preventDefault();
                ...
                <div className='my-5'>
                    <div className="row gy-5 gap-3">
                        ...
                        <div className="col shadow p-5 text-center">
                            <div className='d-flex align-items-center justify-content-center p-2 p-lg-0'>
                    ...
                    <div className='my-5'>
                        <div className="row">
                            ...
                            <div className="col-lg-6 col-md-12 p-4">
                                <form action="" className='border p-5 text-center' onSubmit={handleTestimonialForm}>
                                    <h4 className='fw-bolder text-center mb-5'>Let us know what you think</h4>
                                    <input value={inputData.name} onChange={(e) => setInputData({ ...inputData, name: e.target.value })} type="text" placeholder='Name' className='form-control' />
                                    <input value={inputData.email} onChange={(e) => setInputData({ ...inputData, email: e.target.value })} type="email" placeholder='Email' className='form-control my-4' />
                                    <textarea value={inputData.message} onChange={(e) => setInputData({ ...inputData, message: e.target.value })} type="text" placeholder='Message' className='form-control my-4' />
                                    <button type='submit' style={{ background: '#11999E' }} className='btn text-light '>Submit</button>
                                </form>
                            </div>
                        </div>
                    </div>
