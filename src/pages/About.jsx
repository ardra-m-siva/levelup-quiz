    ...
    return (
        <>
            ...
            <div className='container'>
                ...
                <div className="row text-center m-4 d-flex flex-wrap justify-content-center">
                ...
                <div className='text-center my-5' >
                    ...
                    <div className="row mt-5 g-4">
                        <div className="col-lg col-md-6 col-12 border p-3">
                            <img className='img-fluid' src="https://media.istockphoto.com/id/1365576235/vector/take-small-steps-to-achieve-big-goal-growing-wisely-slow-and-steady-to-reach-target-and.jpg?s=612x612&w=0&k=20&c=nCAD4XVLHMWZE2mA6tJjisjIx8x66zv2HS3b_KuGWL8=" alt="" />
                            <h5 className='my-3 fw-bold'> Bite-sized</h5>
                            <p className='px-2'>Go step-by-step through our unique courses. Access what you've learned with in-lesson quizzes, and gradually advance your skills with practice.</p>
                        </div>

                        <div className="col-lg col-md-6 col-12 border p-3">
                            <img className='img-fluid' src="https://img.freepik.com/premium-vector/motivation-concept-hard-work-like-pushing-boulder-uphill-burden-obstacle-business-difficulty_178888-1778.jpg?w=360" alt="" />
                            <h5 className='my-3 fw-bold'>Tailored for you</h5>
                            <p className='px-2'>No matter your experience level, you'll be writing real, functional code within minutes of starting your first course.</p>
                        </div>

                        <div className="col-lg col-md-6 col-12 border p-3">
                            <img className='img-fluid' src="https://media.licdn.com/dms/image/v2/D5612AQFRn-Km672JPQ/article-cover_image-shrink_720_1280/article-cover_image-shrink_720_1280/0/1659640074035?e=2147483647&v=beta&t=2NZugeUJEYgkqEqhpNwFU6oW-zqzyJNzRk4VdpQ1h-E" alt="" />
                            <h5 className='my-3 fw-bold'>Get proof</h5>
                            <p className='px-2'>Validate your newly acquired skills. Post it on social for others to see.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className=" m-4">
                    ...
                    <div className="row my-5 g-4 align-items-center">
                        <div className="col-lg-6 col-md-12">
                            <div className="p-3">
                                <div>
                                    <h5 className='fs-4 fw-bold'>Lessons in under 5 mins, Progress Tracking</h5>
                                ...
                                <div>
                                    <h5 className='fs-4 fw-bold'>Restart on Failure and Rewards & Achievements</h5>
