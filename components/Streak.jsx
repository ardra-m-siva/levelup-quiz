            ...
            <div style={{
                ...
                <div className='row align-items-center '>
                    ...
                    <div className="col fs-4 text-light border-end">
                        <p className="fw-bold">Current Streak: <span  style={{ color: "#30e3ca",fontSize: "1.5rem",fontWeight: "bold",}}>{9} Days</span></p>
                        <p className="fw-bold">Longest Streak: <span style={{ color: "#FF9F1C", fontSize: "1.5rem", fontWeight: "bold",}}>{16} Days</span></p>
                    </div>
